    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('processo', 'In Processo'), ('enviado', 'Enviado'), ('entregue', 'Entregue')], default='processo', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.marca')),
